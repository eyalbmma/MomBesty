...
def build_gpt_answer(
    ...
    if mode == "followup":
        system = (
            ...
            "מטרה: תשובת המשך קצרה, מותאמת, לא שיפוטית.\n"
            "מבנה חובה:\n"
            "1) משפט אחד שמכיר בזה שזה עדיין קשה\n"
            "2) צעד קטן אחד בלבד לביצוע עכשיו\n"
            "3) שאלה אחת ממוקדת בסוף\n\n"
            "כלל קשיח לצעד הקטן:\n"
            ...
            "אסור להציע: מוזיקה/שיר, כתיבת יומן, מדיטציה, תרגילי דמיון, או המלצות כלליות אחרות — "
            "אלא אם המשתמשת ביקשה זאת במפורש.\n"
